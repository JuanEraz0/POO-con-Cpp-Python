...
int main(){
	...
	while (1)
	{
		...
		namedWindow("ajustes", WINDOW_AUTOSIZE);
		createTrackbar("Umbral", "ajustes", &thresh, 250, track);
		createTrackbar("Maximo", "ajustes", &maxVal, 255, track);
		createTrackbar("Tipo de Umbral", "ajustes", &type, 4, track);
		createTrackbar("Bordes", "ajustes", &deger, 100, track);
		...
		track(0, 0);
        namedWindow("OpenCVUI", WINDOW_AUTOSIZE);
